...
import Sidebar from "../layout/UserSidebar"; // Adjust path as per your project structure
import Header from "../layout/UserHeader"; // Adjust path as per your project structure
