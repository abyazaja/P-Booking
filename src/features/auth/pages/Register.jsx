...
Welcome to P-Booking! You can now:
✅ Login immediately  
✅ Browse available courts
✅ Make bookings instantly
✅ Track your booking history

Ready to play? Let's book your first court!`);
        // Redirect to login after 4 seconds (longer to read message)
        setTimeout(() => {
          navigate('/login');
        }, 4000);
      } else {
