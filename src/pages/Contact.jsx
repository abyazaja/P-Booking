  ...
  <div className="mt-16 mb-24 w-full max-w-3xl mx-auto bg-white/90 rounded-3xl shadow-2xl p-6 md:p-12 text-center">
    ...
    <form className="flex flex-col gap-4">
      <input
        ...
        className="border rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-ballgreen"
      />
      <input
        type="email"
      ...
      <button
        type="submit"
        className="bg-ballgreen text-white py-2 rounded-full font-semibold hover:bg-ballgreen/90 transition"
      >
        Send Message
      </button>
    </form>
