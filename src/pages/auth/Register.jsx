...
export default function Register() {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-4 w-full">
      ...
      <button
        type="submit"
        className="w-full bg-ballorange text-white py-2 rounded-full font-semibold hover:bg-ballorange/90 transition"
      >
        Register
      </button>
      <div className="text-center mt-2">
        <a href="/login" className="text-ballgreen hover:underline">
